# -*- coding: utf-8 -*-
"""
Created on Fri May 09 12:11:41 2014

@author: VASANTH
To capture live datastreams from Tweeter API
"""
...
#        json_data=open('json_data')
               ...
               if (data_stream.has_key('text')):
                   tweet = data_stream['text'].encode('utf8')
                   pprint(tweet)
#				   print "Tweet:"
               if (data_stream.has_key('source')):
                   source = data_stream['source'].encode('utf8')
#				   pprint(source)
 #                 print "Source:"
#               pprint(data_stream)
#            json_data.close()
...
#                   if self.current_file:
 #                      self.current_file.close()
  #                     print "10000 tweets stored, exiting..."
   #                    sys.exit(-1)
